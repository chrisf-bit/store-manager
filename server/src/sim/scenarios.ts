...
const R1_SCENARIOS: Scenario[] = [
  {
    ...
    description: 'Your fresh produce team leader tells you two colleagues have asked to reduce their overtime. They\'re tired and morale is dipping. But the department is already tight on hours, and cutting overtime will leave gaps on the shop floor during the evening rush.',
    options: [
      {
